	...
	<tr>
       ...
       <td>
        {if count($product->get_product_image()) > 0}
            <img src="{$app.const.FRONT_OFFICE_HOST}/product/img/{$product->get_product_image()[0]->get_id()}/25/25.jpg"/>
        {/if}  &nbsp; &nbsp; &nbsp; &nbsp;
       </td>
